        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="cara">
                        <h5 class="text-light">Solicitar <span class="text-warning">Declaração</span></h5></p>
                    </div>
                </div>
            </div>
        </div>
                  ...
                  <div class="forma1">
                    <div class="card1">
                      <div class="card bg-transparent">
                          ...
                          <div class="card-body">
                            <form class="row g-3" action="solcitar.php" method="post">
                                <div class="col-md-3">
                                    <label for="inputEmail4" class="form-label">Declaração</label>
                                    <select id="inpu" name="declara" class="form-select">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="bilhete" id="bilhete" placeholder="insira o numero do BI" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="inputEmail4" class="form-label">Filho(a) de</label>
                                    <input type="text" class="form-control" name="filho" id="filho" placeholder="nome do pai.." required>
                                </div>
                                <div class="col-md-3">
                                    <label for="inputEmail4" class="form-label">e de</label>
                                    <input type="text" class="form-control" name="de" id="de" placeholder="nome da mãe" required>
                                </div>
                                <div class="col-md-1">
                                <label for="inputPassword4" class="form-label">Idade</label>
                                <input type="text" class="form-control" name="idade" id="idade" maxlength="2" placeholder="idade" required>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="residencia" id="residencia" placeholder="Ex: Viana" required>
                                </div>
                                <div class="col-md-3">
                                <label for="inputAddress2" class="form-label">Telemovel</label>
                                  <input type="text" class="form-control" name="telefone" id="telefone" placeholder="+244" maxlength = "9" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="inputAddress2" class="form-label">Matricula</label>
                                    <input type="number" class="form-control" name = "m" id="m" placeholder="Ex: 54586" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <button type="reset" class="btn btn-danger text-white" name="btns"><i class="fa-solid fa-broom"></i>&nbspLimpar</button>
                                ...
                                <div class="modal" tabindex="-1" id="myModal">
                                    <div class="modal-dialog ">
                                        ...
                                        <div class="modal-body bg-success text-light">
                                            <p>O seu de pedido de <?php echo $_SESSION['declara'];?>  foi solicitada com exito senhor <?php echo $_SESSION['nome'];?>, muito em breve entraremos em contacto contigo. Muito obrigada!</p>
                                        </div>
